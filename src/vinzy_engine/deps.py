"""Dependency injection singletons for Vinzy-Engine (community edition)."""
...
def reset_singletons() -> None:
    ...
    global _db, _licensing, _activation, _usage, _anomaly, _webhook
    _db = None
    _licensing = None
    _activation = None
    _usage = None
    ...
    # Reset caches and background processors
